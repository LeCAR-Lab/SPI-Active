...
from spigym.utils.helpers import parse_observation
from spigym.envs.env_utils.visualization import Point
...
class LeggedRobotBase(BaseTask):
    ...
    def _prepare_reward_function(self):
        ...
        self.reward_scales = self.config.rewards.reward_scales.copy()
